...
export const Form: React.FC<FormProps> = ({ sendFormData, text, formDataDictionary, formInputs, selectInputs, buttonProps, setSubmitClicked }) => {
    ...
    return (
        <form className="ss-form-container" onSubmit={handleSubmit}>
            ...
            <div className="ss-form-container__alignment">
                {
                    text != null && (
                        <>
                            <div className="ss-form-container__message">
                                {text}
